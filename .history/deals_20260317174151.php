...
$dealsStmt = $pdo->query('SELECT id, title, tag, items_text, short_note, deal_price_lkr, original_price_lkr, image_url FROM deals WHERE is_active = 1 ORDER BY id DESC');
