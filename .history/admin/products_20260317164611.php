...
$products = $pdo->query('SELECT id, name, category, price, created_at FROM products ORDER BY id DESC')->fetchAll();
            ...
            <tbody>
                <?php foreach ($products as $item): ?>
                    <tr>
                        ...
                        <td><?php echo escape($item['category'] ?? 'Main Courses'); ?></td>
                        <td>LKR <?php echo format_price((float) $item['price']); ?></td>
